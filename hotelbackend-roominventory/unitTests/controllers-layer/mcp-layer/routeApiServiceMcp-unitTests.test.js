...
describe("CreateRoomMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/room/create-room-api.js",
      {
        apiLayer: { CreateRoomManager: ManagerStub },
        "../../RoomInventoryServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createRoom");
