...
const PublicObjectEvents = {
  room: [
    "hotelbackend-roominventory-service-room-created",
    "hotelbackend-roominventory-service-room-updated",
    "hotelbackend-roominventory-service-room-deleted",
    "hotelbackend-roominventory-service-room-retrived",
    "hotelbackend-roominventory-service-rooms-listed",
  ],
};
