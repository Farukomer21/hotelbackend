...
const roomInventoryPackage = grpcObject.roomInventory;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is hotelbackend-roominventory-service",
  });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(roomInventoryPackage.roomInventoryService.service, {
  helloMessage,
  ...sessionRouter,
});
