...
console.log("Starting hotelbackend-roominventory-service service...");
...
const start = async () => {
  process.title = "node-hotelbackend-roominventory-service";
  ...
  try {
    ...
    await setRedisData(
      "hotelbackend-roominventory-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key hotelbackend-roominventory-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "hotelbackend-roominventory-service is listening HTTP/REST port " +
...
/* starting the server hotelbackend-roominventory-service .... */
start();
