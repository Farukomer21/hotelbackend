...
// This script is called from the GetRoomManager
...
const dbScriptGetRoom = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Room.findOne(options);
    ...
    console.log(err);
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenExecuting_dbScriptGetRoom", {
...
module.exports = dbScriptGetRoom;
