...
// This script is called from the UpdateRoomManager
...
const dbScriptUpdateRoom = async (apiManager) => {
  ...
  try {
    ...
    let rowsCount = null;
    let dbDoc = null;
    [rowsCount, [dbDoc]] = await Room.update(dataClause, {
      where: whereClause,
      returning: true,
    });
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptUpdateRoom",
      {
...
module.exports = dbScriptUpdateRoom;
