...
// This script is called from the DeleteRoomManager
...
const dbScriptDeleteRoom = async (apiManager) => {
  const whereClause = apiManager.whereClause;

  try {
    let rowsCount = null;
    let dbDoc = null;
    [rowsCount, [dbDoc]] = await Room.update(
      { isActive: false },
      {
        where: whereClause,
        returning: true,
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptDeleteRoom",
      {
...
module.exports = dbScriptDeleteRoom;
