...
// This script is called from the GetRoomPriceManager
...
const dbScriptGetRoomprice = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await RoomPrice.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetRoomprice",
      {
...
module.exports = dbScriptGetRoomprice;
