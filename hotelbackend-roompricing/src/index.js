...
console.log("Starting hotelbackend-roompricing-service service...");
...
const start = async () => {
  process.title = "node-hotelbackend-roompricing-service";
  ...
  try {
    ...
    await setRedisData(
      "hotelbackend-roompricing-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key hotelbackend-roompricing-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "hotelbackend-roompricing-service is listening HTTP/REST port " +
...
/* starting the server hotelbackend-roompricing-service .... */
start();
