...
const roomPricingPackage = grpcObject.roomPricing;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, { hello: "hello, this is hotelbackend-roompricing-service" });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(roomPricingPackage.roomPricingService.service, {
  helloMessage,
  ...sessionRouter,
});
