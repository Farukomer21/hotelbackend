...
const ProtectedObjectEvents = {
  roomPrice: [
    "hotelbackend-roompricing-service-roomprice-created",
    "hotelbackend-roompricing-service-roomprice-retrived",
    "hotelbackend-roompricing-service-roomprice-updated",
    "hotelbackend-roompricing-service-roomprice-deleted",
    "hotelbackend-roompricing-service-roomprices-listed",
  ],
};
