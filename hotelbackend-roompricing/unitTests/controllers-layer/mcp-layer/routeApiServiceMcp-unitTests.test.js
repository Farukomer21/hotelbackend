...
describe("CreateRoomPriceMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/roomPrice/create-roomprice-api.js",
      {
        apiLayer: { CreateRoomPriceManager: ManagerStub },
        "../../RoomPricingServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createRoomPrice");
