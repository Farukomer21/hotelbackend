...
The `updateRoomPrice` Business API has 5 parameters that must be sent from the controller. Note that all parameters, except session and Redis parameters, should be provided by the client.
...
The `updateRoomPrice` api has got 5 client parameters
