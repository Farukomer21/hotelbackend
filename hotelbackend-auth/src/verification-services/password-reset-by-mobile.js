...
class PasswordResetByMobile extends VerificationServiceBase {
  constructor(req) {
    super(req, "byLink");
    this.startTopic =
      "hotelbackend-user-service-password-reset-by-mobile-start";
    this.completeTopic =
      "hotelbackend-user-service-password-reset-by-mobile-complete";
  }
  ...
  async startPasswordReset() {
    ...
    mobileReset.expireTime = Number(300);
    ...
    const result = {
      status: "OK",
      codeIndex: codeIndex,
      timeStamp: mobileReset.timeStamp,
      date: mobileReset.date,
      expireTime: Number(300),
      verificationType: this.verificationType,
    };

    // in test mode
    result.secretCode = mobileReset.secretCode;
    result.userId = mobileReset.user.id;
