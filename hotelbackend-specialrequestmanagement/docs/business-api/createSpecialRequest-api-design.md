...
The `createSpecialRequest` Business API has 7 parameters that must be sent from the controller. Note that all parameters, except session and Redis parameters, should be provided by the client.
...
| **Description:**   | Reference to the reservation this special request is attached to.                                                                                |          |         |          |                    |
|                    |                                                                                                                                                  |          |         |          |                    |
| `requestText`      | `String`                                                                                                                                         | `Yes`    | `-`     | `body`   | `requestText`      |
| **Description:**   | Free-form user/staff description of the special request.                                                                                         |          |         |          |                    |
|                    |                                                                                                                                                  |          |         |          |                    |
| `status`           | `Enum`                                                                                                                                           | `Yes`    | `-`     | `body`   | `status`           |
| **Description:**   | Current operational status of request: requested, inProgress, fulfilled, denied.                                                                 |          |         |          |                    |
|                    |                                                                                                                                                  |          |         |          |                    |
| `staffNote`        | `Text`                                                                                                                                           | `No`     | `-`     | `body`   | `staffNote`        |
| **Description:**   | Internal staff note for context/auditing fulfillment or denial reasons. Modifiable only by staff-side tools.                                     |          |         |          |                    |
|                    |                                                                                                                                                  |          |         |          |                    |
| `submittedAt`      | `Date`                                                                                                                                           | `No`     | `-`     | `body`   | `submittedAt`      |
| **Description:**   | Timestamp when the request was submitted. If not provided, auto-set to now on create.                                                            |          |         |          |                    |
|                    |                                                                                                                                                  |          |         |          |                    |
| `resolvedAt`       | `Date`                                                                                                                                           | `No`     | `-`     | `body`   | `resolvedAt`       |
| **Description:**   | Timestamp when the special request was completed (fulfilled or denied), set by staff as status changes. Should be null for requested/inProgress. |          |         |          |                    |
|                    |                                                                                                                                                  |          |         |          |                    |
...
The `createSpecialRequest` api has got 4 client parameters
