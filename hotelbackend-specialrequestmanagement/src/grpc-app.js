...
const protoFile = path.join(
  ...
  "grpc-layer",
  "proto",
  "specialRequestManagement.proto",
);
...
const specialRequestManagementPackage = grpcObject.specialRequestManagement;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is hotelbackend-specialrequestmanagement-service",
  });
}
...
server.addService(
  specialRequestManagementPackage.specialRequestManagementService.service,
  {
    helloMessage,
    ...sessionRouter,
  },
