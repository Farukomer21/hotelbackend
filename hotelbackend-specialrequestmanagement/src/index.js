...
console.log(
  "Starting hotelbackend-specialrequestmanagement-service service...",
);
...
const start = async () => {
  process.title = "node-hotelbackend-specialrequestmanagement-service";
  ...
  try {
    ...
    await setRedisData(
      "hotelbackend-specialrequestmanagement-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key hotelbackend-specialrequestmanagement-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "hotelbackend-specialrequestmanagement-service is listening HTTP/REST port " +
...
/* starting the server hotelbackend-specialrequestmanagement-service .... */
start();
