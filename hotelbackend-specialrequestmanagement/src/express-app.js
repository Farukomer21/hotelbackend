...
const {
  ...
  specialRequestRouter,
} = require("restLayer");

app.use("", specialRequestRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "hotelbackend-specialRequestManagement-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="hotelbackend-specialRequestManagement-postman-collection.json"',
  );
