...
// This script is called from the GetSpecialRequestManager
...
const dbScriptGetSpecialrequest = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await SpecialRequest.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetSpecialrequest",
      {
...
module.exports = dbScriptGetSpecialrequest;
