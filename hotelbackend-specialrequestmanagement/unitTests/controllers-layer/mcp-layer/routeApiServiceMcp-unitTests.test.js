...
describe("CreateSpecialRequestMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/specialRequest/create-specialrequest-api.js",
      {
        apiLayer: { CreateSpecialRequestManager: ManagerStub },
        "../../SpecialRequestManagementServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createSpecialRequest");
