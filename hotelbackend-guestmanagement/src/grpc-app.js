...
const guestManagementPackage = grpcObject.guestManagement;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is hotelbackend-guestmanagement-service",
  });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(guestManagementPackage.guestManagementService.service, {
  helloMessage,
  ...sessionRouter,
});
