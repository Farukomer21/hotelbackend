...
// This script is called from the GetGuestManager
...
const dbScriptGetGuest = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Guest.findOne(options);
    ...
    console.log(err);
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenExecuting_dbScriptGetGuest", {
...
module.exports = dbScriptGetGuest;
