...
// This script is called from the DeleteGuestManager
...
const dbScriptDeleteGuest = async (apiManager) => {
  const whereClause = apiManager.whereClause;

  try {
    let rowsCount = null;
    let dbDoc = null;
    [rowsCount, [dbDoc]] = await Guest.update(
      { isActive: false },
      {
        where: whereClause,
        returning: true,
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptDeleteGuest",
      {
...
module.exports = dbScriptDeleteGuest;
