...
console.log("Starting hotelbackend-guestmanagement-service service...");
...
const start = async () => {
  process.title = "node-hotelbackend-guestmanagement-service";
  ...
  try {
    ...
    await setRedisData(
      "hotelbackend-guestmanagement-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key hotelbackend-guestmanagement-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "hotelbackend-guestmanagement-service is listening HTTP/REST port " +
...
/* starting the server hotelbackend-guestmanagement-service .... */
start();
