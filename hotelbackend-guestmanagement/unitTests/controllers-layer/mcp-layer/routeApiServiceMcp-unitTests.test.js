...
describe("CreateGuestMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/guest/create-guest-api.js",
      {
        apiLayer: { CreateGuestManager: ManagerStub },
        "../../GuestManagementServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createGuest");
