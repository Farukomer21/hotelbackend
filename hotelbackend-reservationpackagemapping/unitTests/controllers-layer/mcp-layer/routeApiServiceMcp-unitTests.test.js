...
describe("CreateReservationPackageMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/reservationPackage/create-reservationpackage-api.js",
      {
        apiLayer: { CreateReservationPackageManager: ManagerStub },
        "../../ReservationPackageMappingServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createReservationPackage");
