...
const exposedHeaders = [
  "hotelbackend-access-token",
  "hotelbackend-refresh-token",
  "set-cookie",
];
if (!corsOrigin) {
  app.use(
...
const {
  ...
  reservationPackageRouter,
} = require("restLayer");

app.use("", reservationPackageRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "hotelbackend-reservationPackageMapping-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="hotelbackend-reservationPackageMapping-postman-collection.json"',
  );
