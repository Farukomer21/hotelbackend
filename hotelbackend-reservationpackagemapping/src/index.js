...
console.log(
  "Starting hotelbackend-reservationpackagemapping-service service...",
);
...
const start = async () => {
  process.title = "node-hotelbackend-reservationpackagemapping-service";
  ...
  try {
    ...
    await setRedisData(
      "hotelbackend-reservationpackagemapping-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key hotelbackend-reservationpackagemapping-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "hotelbackend-reservationpackagemapping-service is listening HTTP/REST port " +
...
/* starting the server hotelbackend-reservationpackagemapping-service .... */
start();
