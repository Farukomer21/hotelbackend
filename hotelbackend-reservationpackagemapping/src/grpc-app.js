...
const protoFile = path.join(
  ...
  "grpc-layer",
  "proto",
  "reservationPackageMapping.proto",
);
...
const reservationPackageMappingPackage = grpcObject.reservationPackageMapping;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is hotelbackend-reservationpackagemapping-service",
  });
}
...
server.addService(
  reservationPackageMappingPackage.reservationPackageMappingService.service,
  {
    helloMessage,
    ...sessionRouter,
  },
