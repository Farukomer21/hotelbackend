...
class DeleteReservationPackageMcpController extends ReservationPackageMappingMcpController {
  constructor(params) {
    super("deleteReservationPackage", "deletereservationpackage", params);
    this.dataName = "reservationPackage";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteReservationPackageManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteReservationPackageMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new DeleteReservationPackageMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return DeleteReservationPackageMcpController.getOutputSchema().parse(result);
