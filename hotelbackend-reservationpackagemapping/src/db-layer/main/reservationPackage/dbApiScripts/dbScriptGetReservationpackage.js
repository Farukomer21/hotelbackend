...
// This script is called from the GetReservationPackageManager
...
const dbScriptGetReservationpackage = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await ReservationPackage.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetReservationpackage",
      {
...
module.exports = dbScriptGetReservationpackage;
