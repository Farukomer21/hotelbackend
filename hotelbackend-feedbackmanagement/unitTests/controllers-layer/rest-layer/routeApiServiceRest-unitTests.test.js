...
describe("CreateFeedbackRestController", () => {
  let createFeedback;
  ...
  beforeEach(() => {
    ...
    createFeedback = proxyquire(
      "../../../src/controllers-layer/rest-layer/main/feedback/create-feedback-api.js",
      {
        serviceCommon: {
          HexaLogTypes: {},
        ...
        apiLayer: {
          CreateFeedbackManager: sinon.stub(),
        },
        "../../FeedbackManagementServiceRestController": class {
