...
describe("CreateFeedbackMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/feedback/create-feedback-api.js",
      {
        apiLayer: { CreateFeedbackManager: ManagerStub },
        "../../FeedbackManagementServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createFeedback");
