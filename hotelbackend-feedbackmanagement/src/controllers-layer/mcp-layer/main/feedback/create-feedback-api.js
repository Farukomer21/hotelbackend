...
class CreateFeedbackMcpController extends FeedbackManagementMcpController {
  constructor(params) {
    super("createFeedback", "createfeedback", params);
    this.dataName = "feedback";
    this.crudType = "create";
  }

  createApiManager() {
    return new CreateFeedbackManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: CreateFeedbackMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new CreateFeedbackMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return CreateFeedbackMcpController.getOutputSchema().parse(result);
