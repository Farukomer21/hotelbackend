...
console.log("Starting hotelbackend-feedbackmanagement-service service...");
...
const start = async () => {
  process.title = "node-hotelbackend-feedbackmanagement-service";
  ...
  try {
    ...
    await setRedisData(
      "hotelbackend-feedbackmanagement-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key hotelbackend-feedbackmanagement-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "hotelbackend-feedbackmanagement-service is listening HTTP/REST port " +
...
/* starting the server hotelbackend-feedbackmanagement-service .... */
start();
