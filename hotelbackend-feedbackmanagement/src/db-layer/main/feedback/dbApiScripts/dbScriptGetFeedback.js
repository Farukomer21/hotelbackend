...
// This script is called from the GetFeedbackManager
...
const dbScriptGetFeedback = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Feedback.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetFeedback",
      {
...
module.exports = dbScriptGetFeedback;
