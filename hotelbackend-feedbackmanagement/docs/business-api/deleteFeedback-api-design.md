# Business API Design Specification - `Delete Feedback`
...
The `deleteFeedback` Business API includes a REST controller that can be triggered via the following route:
