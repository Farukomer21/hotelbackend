...
describe("CreatePersonnelRestController", () => {
  let createPersonnel;
  ...
  beforeEach(() => {
    ...
    createPersonnel = proxyquire(
      "../../../src/controllers-layer/rest-layer/main/personnel/create-personnel-api.js",
      {
        serviceCommon: {
          HexaLogTypes: {},
        ...
        apiLayer: {
          CreatePersonnelManager: sinon.stub(),
        },
        "../../PersonnelManagementServiceRestController": class {
