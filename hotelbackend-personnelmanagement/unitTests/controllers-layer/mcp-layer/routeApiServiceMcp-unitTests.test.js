...
describe("CreatePersonnelMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/personnel/create-personnel-api.js",
      {
        apiLayer: { CreatePersonnelManager: ManagerStub },
        "../../PersonnelManagementServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createPersonnel");
