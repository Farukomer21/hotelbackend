...
// This script is called from the GetPersonnelManager
...
const dbScriptGetPersonnel = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Personnel.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetPersonnel",
      {
...
module.exports = dbScriptGetPersonnel;
