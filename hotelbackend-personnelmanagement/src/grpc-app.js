...
const personnelManagementPackage = grpcObject.personnelManagement;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is hotelbackend-personnelmanagement-service",
  });
}
...
server.addService(
  personnelManagementPackage.personnelManagementService.service,
  {
    helloMessage,
    ...sessionRouter,
  },
