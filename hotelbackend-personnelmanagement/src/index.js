...
console.log("Starting hotelbackend-personnelmanagement-service service...");
...
const start = async () => {
  process.title = "node-hotelbackend-personnelmanagement-service";
  ...
  try {
    ...
    await setRedisData(
      "hotelbackend-personnelmanagement-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key hotelbackend-personnelmanagement-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "hotelbackend-personnelmanagement-service is listening HTTP/REST port " +
...
/* starting the server hotelbackend-personnelmanagement-service .... */
start();
