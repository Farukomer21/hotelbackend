...
describe("CreatePaymentMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/payment/create-payment-api.js",
      {
        apiLayer: { CreatePaymentManager: ManagerStub },
        "../../PaymentManagementServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createPayment");
