...
console.log("Starting hotelbackend-paymentmanagement-service service...");
...
const start = async () => {
  process.title = "node-hotelbackend-paymentmanagement-service";
  ...
  try {
    ...
    await setRedisData(
      "hotelbackend-paymentmanagement-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key hotelbackend-paymentmanagement-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "hotelbackend-paymentmanagement-service is listening HTTP/REST port " +
...
/* starting the server hotelbackend-paymentmanagement-service .... */
start();
