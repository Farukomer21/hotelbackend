...
// This script is called from the GetPaymentManager
...
const dbScriptGetPayment = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Payment.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetPayment",
      {
...
module.exports = dbScriptGetPayment;
