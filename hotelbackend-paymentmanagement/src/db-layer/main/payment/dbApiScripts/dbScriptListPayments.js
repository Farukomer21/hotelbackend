...
// This script is called from the ListPaymentsManager
...
const dbScriptListPayments = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListPayments",
      {
...
module.exports = dbScriptListPayments;
