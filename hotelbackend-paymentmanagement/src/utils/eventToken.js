...
const PublicObjectEvents = {
  payment: [
    "hotelbackend-paymentmanagement-service-payment-created",
    "hotelbackend-paymentmanagement-service-payment-retrived",
    "hotelbackend-paymentmanagement-service-payment-updated",
    "hotelbackend-paymentmanagement-service-payment-deleted",
    "hotelbackend-paymentmanagement-service-payments-listed",
    "hotelbackend-paymentmanagement-service-paymentsbyreservationcode-retrived",
  ],
};
