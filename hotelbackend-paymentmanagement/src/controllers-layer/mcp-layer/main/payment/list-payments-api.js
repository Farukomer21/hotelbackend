...
module.exports = (headers) => {
  return {
    name: "listPayments",
    description:
      "Lists all payments for staff/internal tools. Supports filters for reservationId, paymentMethod, paidAt (date), and status. Sorted descending by paidAt for reporting/audit. Returns all non-deleted payments unless filtered.",
