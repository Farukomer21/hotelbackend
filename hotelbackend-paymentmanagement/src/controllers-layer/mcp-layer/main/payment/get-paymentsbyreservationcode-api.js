...
class GetPaymentsByReservationCodeMcpController extends PaymentManagementMcpController {
  constructor(params) {
    super(
  ...
  createApiManager() {
    return new GetPaymentsByReservationCodeManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    name: "getPaymentsByReservationCode",
    description:
    ...
    parameters: GetPaymentsByReservationCodeMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetPaymentsByReservationCodeMcpController(
        mcpParams,
      );
      try {
        const result = await controller.processRequest();
        //return GetPaymentsByReservationCodeMcpController.getOutputSchema().parse(result);
