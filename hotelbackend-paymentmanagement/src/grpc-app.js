...
const paymentManagementPackage = grpcObject.paymentManagement;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is hotelbackend-paymentmanagement-service",
  });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(paymentManagementPackage.paymentManagementService.service, {
  helloMessage,
  ...sessionRouter,
});
