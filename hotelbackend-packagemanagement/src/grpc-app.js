...
const packageManagementPackage = grpcObject.packageManagement;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is hotelbackend-packagemanagement-service",
  });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(packageManagementPackage.packageManagementService.service, {
  helloMessage,
  ...sessionRouter,
});
