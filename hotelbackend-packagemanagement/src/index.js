...
console.log("Starting hotelbackend-packagemanagement-service service...");
...
const start = async () => {
  process.title = "node-hotelbackend-packagemanagement-service";
  ...
  try {
    ...
    await setRedisData(
      "hotelbackend-packagemanagement-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key hotelbackend-packagemanagement-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "hotelbackend-packagemanagement-service is listening HTTP/REST port " +
...
/* starting the server hotelbackend-packagemanagement-service .... */
start();
