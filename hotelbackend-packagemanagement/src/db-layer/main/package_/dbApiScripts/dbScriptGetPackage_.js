...
// This script is called from the GetPackageManager
...
const dbScriptGetPackage_ = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Package_.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetPackage_",
      {
...
module.exports = dbScriptGetPackage_;
