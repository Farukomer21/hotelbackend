...
describe("CreatePackageMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/package_/create-package_-api.js",
      {
        apiLayer: { CreatePackageManager: ManagerStub },
        "../../PackageManagementServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createPackage");
