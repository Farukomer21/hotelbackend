...
By utilizing these common parameters, you can tailor the behavior of API requests to suit your specific requirements, ensuring optimal performance and usability of the `PackageManagement` service.
...
_Resource Definition_ : A value-added hotel package/service that can be assigned to a reservation. Includes package name, description, pricing, validity dates, and activation status.
_Package\_ Resource Properties_
| Name | Type | Required | Default | Definition |
| ---- | ---- | -------- | ------- | ---------- |
| **name** | String | | | _Display name of the package (e.g., &#39;Breakfast&#39;, &#39;Airport Transfer&#39;, &#39;Spa Access&#39;)._ |
| **description** | Text | | | _Longer, optional description of the package, features, or details._ |
| **price** | Double | | | _The price of the package in the base currency. Must be &gt;= 0._ |
| **availableFrom** | Date | | | _Date from which the package is offered/bookable._ |
| **availableTo** | Date | | | _Date until which the package is offered/bookable (inclusive)._ |

## Business Api

### Create Package\_ API

_API Definition_ : Create a new hotel package with name, price, validity range, and availability flag.
...
> For a detailed description of the `` api with its internal and inter-service logic please refer to the [Business API Specification Document For Create Package\_](businessApi/createPackage).

### Update Package\_ API

_API Definition_ : Update existing package by id. Allows changing name, description, price, validity dates, and active status.
...
_API Definition_ : Delete a package by id (soft delete). Only for staff/internal use. Package becomes unavailable for selection on reservations.
...
_API Definition_ : Fetch a package by unique id. Returns package details for staff/internal tools.
...
_API Definition_ : List (and filter/search) all packages offered by the hotel. Filter by name, isActive, price, and available dates.
