...
describe("CreateReservationMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/reservation/create-reservation-api.js",
      {
        apiLayer: { CreateReservationManager: ManagerStub },
        "../../ReservationManagementServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createReservation");
