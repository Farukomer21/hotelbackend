...
console.log("Starting hotelbackend-reservationmanagement-service service...");
...
const start = async () => {
  process.title = "node-hotelbackend-reservationmanagement-service";
  ...
  try {
    ...
    await setRedisData(
      "hotelbackend-reservationmanagement-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key hotelbackend-reservationmanagement-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "hotelbackend-reservationmanagement-service is listening HTTP/REST port " +
...
/* starting the server hotelbackend-reservationmanagement-service .... */
start();
