...
const { ReservationUpdatedPublisher } = require("../../api-events/publishers");
...
const { dbScriptUpdateReservation } = require("dbLayer");
...
class UpdateReservationManager extends ReservationManager {
  ...
  async doBusiness() {
    const reservation = await dbScriptUpdateReservation(this);
    return reservation;
  }
