...
// This script is called from the UpdateReservationManager
...
const dbScriptUpdateReservation = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptUpdateReservation",
      {
...
module.exports = dbScriptUpdateReservation;
