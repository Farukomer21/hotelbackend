...
// This script is called from the GetReservationByIdManager
...
const dbScriptGetReservation = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetReservation",
      {
...
module.exports = dbScriptGetReservation;
