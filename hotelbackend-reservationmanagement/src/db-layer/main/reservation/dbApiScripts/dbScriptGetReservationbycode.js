...
// This script is called from the GetReservationByCodeManager
...
const dbScriptGetReservationbycode = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Reservation.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetReservationbycode",
      {
...
module.exports = dbScriptGetReservationbycode;
